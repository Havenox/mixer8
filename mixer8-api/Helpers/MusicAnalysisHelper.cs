...
public static class MusicAnalysisHelper
{
        ...
        double totalBeats)
    {
        ...
        if (!isMinorKey)
        {
            field.Add((keyRoot, false));                    // I Maior
            field.Add(((keyRoot + 2) % 12, true));         // ii Menor
            field.Add(((keyRoot + 4) % 12, true));         // iii Menor
            field.Add(((keyRoot + 5) % 12, false));        // IV Maior
            field.Add(((keyRoot + 7) % 12, false));        // V Maior
            field.Add(((keyRoot + 7) % 12, true));         // v Menor
            field.Add(((keyRoot + 9) % 12, true));         // vi Menor
            field.Add(((keyRoot + 11) % 12, true));        // vii° Dim
        }
        else
        {
            field.Add((keyRoot, true));                     // i Menor
            field.Add(((keyRoot + 2) % 12, true));         // ii° Dim
            field.Add(((keyRoot + 3) % 12, false));        // III Maior
            field.Add(((keyRoot + 5) % 12, true));         // iv Menor
            field.Add(((keyRoot + 7) % 12, true));         // v Menor
            field.Add(((keyRoot + 7) % 12, false));        // V Maior Dominante
            field.Add(((keyRoot + 8) % 12, false));        // VI Maior
            field.Add(((keyRoot + 10) % 12, false));       // VII Maior
        }
