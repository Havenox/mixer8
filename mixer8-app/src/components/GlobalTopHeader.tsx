...
export const GlobalTopHeader: React.FC = () => {
  ...
  return (
    <header className="w-full bg-[#0d0d0d]/95 backdrop-blur-md border-b border-brand-hover/80 px-2 md:px-6 h-[50px] md:h-[72px] flex items-center justify-between gap-1.5 md:gap-4 shrink-0 select-none z-30 transition-all">
      ...
      <div className="flex items-center justify-end md:justify-end gap-1 md:gap-3 w-full md:w-auto py-0.5">
        ...
        {activeOverlay === 'daw' && (
          <div className="h-[32px] md:h-[46px] w-[80px] sm:w-[110px] md:w-[150px] bg-[#181818] border border-white/10 rounded-md md:rounded-lg flex items-center overflow-hidden shrink-0 select-none shadow-md transition-all duration-200 hover:bg-[#222222] animate-in fade-in duration-200">
            <button
              ...
              className="h-full w-5 md:w-9 flex items-center justify-center text-brand-gray hover:text-white hover:bg-white/5 border-r border-white/10 transition-colors cursor-pointer disabled:text-white/10 disabled:pointer-events-none active:scale-95 shrink-0"
            ...
            <div 
              ...
              className="flex flex-col items-center justify-center leading-none flex-1 min-w-0 px-0.5 cursor-pointer select-none active:opacity-70 transition-opacity"
              title="Redefinir Zoom"
            >
              <span className="text-[6px] md:text-[8px] font-extrabold text-brand-gray/50 uppercase tracking-widest leading-none mb-0.5 truncate w-full text-center">Zoom</span>
            ...
            <button
              ...
              className="h-full w-5 md:w-9 flex items-center justify-center text-brand-gray hover:text-white hover:bg-white/5 border-l border-white/10 transition-colors cursor-pointer disabled:text-white/10 disabled:pointer-events-none active:scale-95 shrink-0"
        ...
        {activeOverlay === 'lyrics' && (
          <button
            ...
            className="h-[32px] md:h-[46px] w-[44px] sm:w-[60px] md:w-[90px] bg-[#181818] border border-white/10 rounded-md md:rounded-lg flex flex-col items-center justify-center shrink-0 shadow-md cursor-pointer select-none transition-all duration-200 hover:bg-[#222222] active:scale-95 animate-in fade-in duration-200"
            title="Alternar Exibição de Cifras"
          >
            <span className="text-[6px] md:text-[8px] font-extrabold text-brand-gray/50 uppercase tracking-widest leading-none mb-0.5">
              Cifra
            </span>
            {showChords ? (
        ...
        <div className="h-[32px] md:h-[46px] w-[46px] sm:w-[64px] md:w-24 bg-[#181818] border border-white/10 rounded-md md:rounded-lg flex flex-col items-center justify-center shrink-0 shadow-md transition-all duration-200 hover:bg-[#222222]">
          <span className="text-[6px] md:text-[8px] font-extrabold text-brand-gray/50 uppercase tracking-widest leading-none mb-0.5">
            Acorde
          </span>
          <span className="text-[9px] md:text-xs lg:text-sm font-black text-brand-green tracking-wider font-mono leading-none text-center drop-shadow-[0_0_6px_rgba(34,197,94,0.35)]">
            {currentChord || '--'}
          </span>
        </div>
        ...
        <div className="h-[32px] md:h-[46px] w-[80px] sm:w-[110px] md:w-[160px] bg-[#181818] border border-white/10 rounded-md md:rounded-lg flex items-center overflow-hidden shrink-0 shadow-md transition-all duration-200 hover:bg-[#222222]">
          ...
          >
            <span className="text-[6px] md:text-[8px] font-extrabold text-brand-gray/50 uppercase tracking-widest leading-none mb-0.5 truncate w-full text-center">
              Tom
            </span>
